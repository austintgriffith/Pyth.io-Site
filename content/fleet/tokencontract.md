...
contract Token is StandardToken, Ownable, HasNoEther, Contactable, Addressed {
  ...
  event Stake(address indexed sender, bytes32 indexed response, uint256 value, uint256 total);
